...
local NodePoker = import( "app.viewslikuimajiang.NodePoker" )
...
function GamePlay:ctor( param )
    ...
    self._pokerStack = getRandomArray( 1,39 )-- 随机一副牌
...
function GamePlay:getNumberIndexSourceByNode( node )
	...
	table.sort( player_childs, function ( a,b )
		...
		elseif a:getNumberOfBigOrSmall() ~= b:getNumberOfBigOrSmall() then
