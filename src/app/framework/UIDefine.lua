...
-- 	Skill_UI = { layer = import("app.viewshunzhan.GameSkill"),flag = UIDefine.LayerFlag.Main.name,name = "HunZhan_Skill_UI" },
-- }

-- UIDefine.FIGHTPHYSICS_KEY = {
-- 	Main_UI = { layer = import("app.viewsphysics.MainGame"),flag = UIDefine.LayerFlag.Main.name,name = "FightPhysics_MainGame_UI" },
-- }
...
UIDefine.RPGFIGHT_KEY = {
	...
	Operation_UI = { layer = import("app.viewsrpgfight.GameOperation"),flag = UIDefine.LayerFlag.Main.name,name = "RpgFight_Operation_UI" },
}
