...
if zuqiu_card_lang == 1 then
	country_config.europe  = {
		...
		[14]	= { icon = "image/flag/Russiagq.png",		text = "image/flag/Russia.png" 		 },
		[15]	= { icon = "image/flag/Francegq.png",		text = "image/flag/France.png" 		 },
		-- [16]	= { icon = "image/flag/Ukrainegq.png",		text = "image/flag/Ukraine.png" 	 },
