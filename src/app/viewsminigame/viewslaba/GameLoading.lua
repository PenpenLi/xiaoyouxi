...
function GameLoading:ctor( param )
    ...
    self:addCsb( "csbminigame/csblaba/Loading.csb" )


    self._plist = {
		"csbminigame/csblaba/Plist1.plist",
		"csbminigame/csblaba/Plist2.plist",
		"csbminigame/csblaba/Plist3.plist",
		-- "Plist4.plist",
		-- "Plist5.plist"
	}
	self._music = {
	...
	schedule( self.LoadingBar, function()
		...
		if self._index >= self._total then
			...
			performWithDelay( self,function()
				...
				removeUIFromScene( UIDefine.MINIGAME_KEY.LaBa_Loading_UI )
			end,0.5 )
		end
	end,0.02)
end
