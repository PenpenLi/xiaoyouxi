...
function GamePlay:isGameOver( winType )
	if winType == 1 then
		...
		local call_back = function() 
			addUIToScene( UIDefine.MINIGAME_KEY.ZuQiu_Lose_UI,{ country_index = self._countryIndex } )
		end
	...
	elseif winType == 2 then
		...
		local call_back = function()
			addUIToScene( UIDefine.MINIGAME_KEY.ZuQiu_Win_UI,{ country_index = self._countryIndex } )
		end
...
function GamePlay:clickBack()
	...
	addUIToScene( UIDefine.MINIGAME_KEY.ZuQiu_Start_UI )
end
