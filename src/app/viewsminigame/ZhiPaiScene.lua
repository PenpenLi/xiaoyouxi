...
cc.FileUtils:getInstance():addSearchPath("res/csbminigame/csbzhipai")
...
function ZhiPaiScene:loadAppFile()
	import("app.viewsminigame.viewszhipai.config.zhipai_config")
end
...
function ZhiPaiScene:onEnter()
	-- 创建LoadingUI
	addUIToScene( UIDefine.MINIGAME_KEY.ZhiPai_Loading_UI )
end
