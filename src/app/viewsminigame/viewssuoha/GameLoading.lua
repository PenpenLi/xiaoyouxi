...
function GameLoading:ctor( param )
	...
	self:addCsb( "csbminigame/csbsuoha/Loading.csb" )

	self._plist = {
		"csbminigame/csbsuoha/SuoHaPlist1.plist",
		"csbminigame/csbsuoha/SuoHaPlist2.plist",
	}
...
function GameLoading:loadStart()
	removeUIFromScene( UIDefine.MINIGAME_KEY.SuoHa_Loading_UI )
	addUIToScene( UIDefine.MINIGAME_KEY.SuoHa_Start_UI )
end
