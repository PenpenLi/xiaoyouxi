...
function GamePlay:gameOver( score )
	...
	-- end
	addUIToScene( UIDefine.MINIGAME_KEY.SuoHa_Over_UI,score )
end
--判断panel是否放满
...
function GamePlay:clickMusic()
	addUIToScene( UIDefine.MINIGAME_KEY.SuoHa_Voice_UI )
end
function GamePlay:clickBack()
	removeUIFromScene( UIDefine.MINIGAME_KEY.SuoHa_Play_UI )
