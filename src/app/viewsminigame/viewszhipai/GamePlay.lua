...
function GamePlay:gameOver()
    ...
    addUIToScene( UIDefine.MINIGAME_KEY.ZhiPai_Over_UI,{ score = self._totalScore } )
end
...
function GamePlay:gamePass()
    ...
    addUIToScene( UIDefine.MINIGAME_KEY.ZhiPai_Pass_UI,{ level = self._curLevel + 1 } )
end
...
function GamePlay:pauseGame()
    self:stopSchedule()
    addUIToScene( UIDefine.MINIGAME_KEY.ZhiPai_Pause_UI,{ layer = self } )
end
