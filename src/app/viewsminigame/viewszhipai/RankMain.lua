...
function RankMain:ctor( param )
    ...
    self:addCsb( "csbzhipai/Rank.csb",2 )

    -- 关闭
    self:addNodeClick( self.ImageRankClose,{ 
...
function RankMain:onEnter()
    ...
    casecadeFadeInNode( self.ImageRankBg,0.5 )
...
function RankMain:close()
    removeUIFromScene( UIDefine.MINIGAME_KEY.ZhiPai_Rank_UI )
end
