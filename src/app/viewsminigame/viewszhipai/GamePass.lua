...
function GamePass:close()
    ...
    removeUIFromScene( UIDefine.MINIGAME_KEY.ZhiPai_Pass_UI )
    removeUIFromScene( UIDefine.MINIGAME_KEY.ZhiPai_Play_UI )
    addUIToScene( UIDefine.MINIGAME_KEY.ZhiPai_Play_UI,{ level = next_level } )
end
