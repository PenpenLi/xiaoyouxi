...
function GamePlay:gameOver( score )
	...
	-- 显示结算界面
	performWithDelay( self,function()
		addUIToScene( UIDefine.MINIGAME_KEY.LiKui_Over_UI,score )
	end,5 )
end
...
function GamePlay:back()
	addUIToScene( UIDefine.MINIGAME_KEY.LiKui_Start_UI )
	removeUIFromScene( UIDefine.MINIGAME_KEY.LiKui_Play_UI )
end
