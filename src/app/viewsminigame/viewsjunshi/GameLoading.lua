...
function GameLoading:ctor( param )
    ...
    self:addCsb( "csbminigame/csbjunshi/Loading.csb" )

    self._plist = {
		"csbminigame/csbjunshi/JunShiPlist1.plist",
		"csbminigame/csbjunshi/JunShiPlist2.plist",
		"csbminigame/csbjunshi/JunShiPlist3.plist"
	}
	self._music = {
		"jsmp3/game.mp3",
		"jsmp3/login.mp3"
	...
	schedule( self.LoadingBar, function()
		...
		if self._index >= self._total then
			...
			performWithDelay( self,function()
				...
				removeUIFromScene( UIDefine.MINIGAME_KEY.JunShi_Loading_UI )
			end,0.5 )
		end
	end,0.02)
end
