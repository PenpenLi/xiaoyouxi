...
function LaBaScene:loadAppFile()
	import("app.viewsminigame.viewslaba.config.laba_config")

	if laba_config.lang == 1 then
		cc.FileUtils:getInstance():addSearchPath("res/csbminigame/csblaba")
	else
...
function LaBaScene:onEnter()
	...
	local call = cc.CallFunc:create( function()
		-- 创建LoadingUI
		addUIToScene( UIDefine.MINIGAME_KEY.LaBa_Loading_UI )
	end )
