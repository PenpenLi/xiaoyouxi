...
local InnerProtocol = {
	...
	INNER_EVENT_FENSUI_FIGHT_DEAD											= "INNER_EVENT_FENSUI_FIGHT_DEAD",
	INNER_EVENT_RPGFIGHT_LOADPEOPLE_TOUCHBEGAN								= "INNER_EVENT_RPGFIGHT_LOADPEOPLE_TOUCHBEGAN",
	INNER_EVENT_RPGFIGHT_LOADPEOPLE_TOUCHEND_TRUE							= "INNER_EVENT_RPGFIGHT_LOADPEOPLE_TOUCHEND_TRUE",
	INNER_EVENT_RPGFIGHT_LOADPEOPLE_TOUCHEND_FALSE							= "INNER_EVENT_RPGFIGHT_LOADPEOPLE_TOUCHEND_FALSE",
}
