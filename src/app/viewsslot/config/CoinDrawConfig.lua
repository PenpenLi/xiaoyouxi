local CoinDrawConfig = {
    ...
    [6] = {WheelId=1001,Order=6,Weight=50,BaseCoinReward=1000,KeepOn=1},
    [7] = {WheelId=1001,Order=7,Weight=40,BaseCoinReward=2000,KeepOn=1},
    [8] = {WheelId=1001,Order=8,Weight=300,BaseCoinReward=5000,KeepOn=1},
    [9] = {WheelId=1001,Order=9,Weight=200,BaseCoinReward=10000,KeepOn=1},
