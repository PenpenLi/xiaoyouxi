...
local GameSanGuoHelp = class( "GameHelp",BaseLayer )


function GameSanGuoHelp:ctor( param )
	assert( param," !! param is nil !! ")
    assert( param.name," !! param.name is nil !! ")
    GameSanGuoHelp.super.ctor( self,param.name )--执行父类的构造函数
...
function GameSanGuoHelp:onEnter()
    GameSanGuoHelp.super.onEnter( self )
...
function GameSanGuoHelp:close()
	removeUIFromScene( UIDefine.HEJI_KEY.SanGuo_Help_UI )
	-- body
end
